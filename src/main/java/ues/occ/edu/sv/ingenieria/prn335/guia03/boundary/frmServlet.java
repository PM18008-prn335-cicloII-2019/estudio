 ...
 */
package ues.occ.edu.sv.ingenieria.prn335.guia03.boundary;
...
import ues.occ.edu.sv.ingenieria.prn335.guia03.controller.UtilidadesFacade;
...
UtilidadesFacade utilidades =new UtilidadesFacade();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getParameter("btnBuscar").equals("SalaPorAsiento")){
                
                out.println("<table border='1'>");
                //for(Sala sala :utilidades.){
